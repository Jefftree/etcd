	...
	tcs := []struct {
		...
		},
		{
			...
			operations: []batch{
				...
				{
					snapshot: &walpb.Snapshot{Index: toPtr(uint64(3)), Term: toPtr(uint64(0)), ConfState: &raftpb.ConfState{}},
				},
				{
					state:   &raftpb.HardState{Commit: 5},
		...
		},
		{
			...
			readAt: walpb.Snapshot{Index: toPtr(uint64(3))},
			walReadAll: want{
				wantState:   raftpb.HardState{Commit: 5},
		...
		},
		{
			...
			operations: []batch{
				{
					snapshot: &walpb.Snapshot{Index: toPtr(uint64(4)), Term: toPtr(uint64(0)), ConfState: &raftpb.ConfState{}},
				},
				{
					state:   &raftpb.HardState{Commit: 2},
					entries: []raftpb.Entry{{Index: 1, Data: []byte("a")}, {Index: 2, Data: []byte("b")}},
			...
			readAt: walpb.Snapshot{Index: toPtr(uint64(4))},
			walReadAll: want{
